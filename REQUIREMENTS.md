...
| R4.3 | DLQ captures invalid or repeatedly failed events. | Bus DLQ tests, ack/inflight retry tests, trace-write and trace-ingested worker invalid payload DLQ tests, `beaterctl bus-fixture`; replay path still required |
