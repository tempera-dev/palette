...
before the public clone/full wrapper run, wait for the wrapper's manual
quickstart checkpoint before diagnostic auto-confirmation, and still leave the
unaided outside-person proof as the only Gate 2 completion evidence.
