...
| ID | Requirement | Evidence required |
| --- | --- | --- |
| R11.1 | Time-to-first-trace is under 5 minutes. | Fresh-machine quickstart runbook, timed smoke test, and completed unaided outside-person evidence in `docs/demos/gate2-outside-person-proof.md` with `scripts/validate-gate2-outside-proof.sh` passing against the matching stopwatch proof and committed recording |
