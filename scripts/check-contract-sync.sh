#!/usr/bin/env bash
# One-command drift test: proves the API contract, the 11 SDK clients, the MCP
...
step "2/5 spec + all 11 SDK clients are current (regen --check)"
...
echo "No drift: API, 11 SDKs, MCP tools, docs, and conventions are all in sync."
