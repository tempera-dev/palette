...
| `beater-otlp` (OTLP HTTP/gRPC receive, normalizer) | §9, §7 | built | **Built** — `crates/beater-otlp/` in workspace | Handles OTLP gRPC, scoped HTTP/protobuf, collector HTTP/JSON, and OpenInference/`gen_ai` → canonical |
