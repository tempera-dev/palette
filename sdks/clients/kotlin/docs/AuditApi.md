...
# **listAuditEvents**
> kotlin.collections.List&lt;AuditEvent&gt; listAuditEvents(tenantId, projectId, authorization, xBeaterApiKey, xBeaterProjectId, xBeaterEnvironmentId)
...
try {
    ...
    println("4xx response calling AuditApi#listAuditEvents")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AuditApi#listAuditEvents")
    e.printStackTrace()
}
```
