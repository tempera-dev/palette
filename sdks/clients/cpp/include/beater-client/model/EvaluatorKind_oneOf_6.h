...
#define ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_6_H_
...
{
public:
    EvaluatorKind_oneOf_6();
    virtual ~EvaluatorKind_oneOf_6();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_6_H_ */
