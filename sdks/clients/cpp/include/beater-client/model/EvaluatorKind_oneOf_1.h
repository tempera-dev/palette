...
/*
 * EvaluatorKind_oneOf_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_1_H_
...
class  EvaluatorKind_oneOf_1
    : public ModelBase
{
public:
    EvaluatorKind_oneOf_1();
    virtual ~EvaluatorKind_oneOf_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_1_H_ */
