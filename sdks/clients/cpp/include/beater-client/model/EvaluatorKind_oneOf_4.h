...
/*
 * EvaluatorKind_oneOf_4.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_4_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_4_H_
...
class  EvaluatorKind_oneOf_4
    : public ModelBase
{
public:
    EvaluatorKind_oneOf_4();
    virtual ~EvaluatorKind_oneOf_4();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_EvaluatorKind_oneOf_4_H_ */
