...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_RsiApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_RsiApi_H_
...
public:
    ...
    explicit RsiApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// <param name="gateCandidateRequest"></param>
    ...
    pplx::task<std::shared_ptr<GateCandidateResponse>> gateOptimizationCandidate(
        utility::string_t tenantId,
        utility::string_t projectId,
        std::shared_ptr<GateCandidateRequest> gateCandidateRequest,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_RsiApi_H_ */
