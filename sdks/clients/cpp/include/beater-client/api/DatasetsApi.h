...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_DatasetsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_DatasetsApi_H_
...
public:
    ...
    explicit DatasetsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<DatasetVersionSnapshot>> datasets_createDatasetVersion(
        ...
        std::shared_ptr<CreateDatasetVersionRequest> createDatasetVersionRequest,
        boost::optional<utility::string_t> authorization,
        boost::optional<utility::string_t> xBeaterApiKey,
        boost::optional<utility::string_t> xBeaterProjectId,
        boost::optional<utility::string_t> xBeaterEnvironmentId
    ...
    pplx::task<std::shared_ptr<DatasetCase>> datasets_promoteDatasetCaseFromTrace(
        ...
        utility::string_t projectId,
        utility::string_t datasetId,
        std::shared_ptr<PromoteTraceCaseRequest> promoteTraceCaseRequest,
        boost::optional<utility::string_t> authorization,
        boost::optional<utility::string_t> xBeaterApiKey,
        boost::optional<utility::string_t> xBeaterProjectId,
        boost::optional<utility::string_t> xBeaterEnvironmentId
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_DatasetsApi_H_ */
