...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_ConnectApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ConnectApi_H_
...
public:
    ...
    explicit ConnectApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<PaletteConnectStatusResponse>> connect_getPaletteConnectStatus(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ConnectApi_H_ */
