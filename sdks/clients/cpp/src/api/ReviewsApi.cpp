...
pplx::task<std::shared_ptr<ReviewQueue>> ReviewsApi::reviews_createQueue(utility::string_t tenantId, utility::string_t projectId, std::shared_ptr<CreateReviewQueueHttpRequest> createReviewQueueHttpRequest, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xPaletteApiKey, boost::optional<utility::string_t> xPaletteProjectId, boost::optional<utility::string_t> xPaletteEnvironmentId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ReviewsApi->reviews_createQueue does not produce any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling reviews_createQueue: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling reviews_createQueue: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling reviews_createQueue: unsupported response type"));
        }

        return localVarResult;
    });
}
pplx::task<std::shared_ptr<ReviewTask>> ReviewsApi::reviews_enqueueTaskFromTrace(utility::string_t tenantId, utility::string_t projectId, utility::string_t queueId, std::shared_ptr<EnqueueReviewTaskFromTraceHttpRequest> enqueueReviewTaskFromTraceHttpRequest, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xPaletteApiKey, boost::optional<utility::string_t> xPaletteProjectId, boost::optional<utility::string_t> xPaletteEnvironmentId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'enqueueReviewTaskFromTraceHttpRequest' when calling ReviewsApi->reviews_enqueueTaskFromTrace"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ReviewsApi->reviews_enqueueTaskFromTrace does not produce any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling reviews_enqueueTaskFromTrace: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling reviews_enqueueTaskFromTrace: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling reviews_enqueueTaskFromTrace: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<ReviewTask>>> ReviewsApi::reviews_listTasks(utility::string_t tenantId, utility::string_t projectId, utility::string_t queueId, boost::optional<std::shared_ptr<ReviewTaskState>> state, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xPaletteApiKey, boost::optional<utility::string_t> xPaletteProjectId, boost::optional<utility::string_t> xPaletteEnvironmentId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ReviewsApi->reviews_listTasks does not produce any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling reviews_listTasks: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling reviews_listTasks: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling reviews_listTasks: unsupported response type"));
        }

        return localVarResult;
    });
}
pplx::task<std::shared_ptr<DatasetCase>> ReviewsApi::reviews_promoteAnnotation(utility::string_t tenantId, utility::string_t projectId, utility::string_t queueId, utility::string_t taskId, utility::string_t annotationId, std::shared_ptr<PromoteReviewAnnotationHttpRequest> promoteReviewAnnotationHttpRequest, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xPaletteApiKey, boost::optional<utility::string_t> xPaletteProjectId, boost::optional<utility::string_t> xPaletteEnvironmentId) const
{

    // verify the required parameter 'promoteReviewAnnotationHttpRequest' is set
    if (promoteReviewAnnotationHttpRequest == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'promoteReviewAnnotationHttpRequest' when calling ReviewsApi->reviews_promoteAnnotation"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ReviewsApi->reviews_promoteAnnotation does not produce any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling reviews_promoteAnnotation: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling reviews_promoteAnnotation: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling reviews_promoteAnnotation: unsupported response type"));
        }

        return localVarResult;
    });
}
pplx::task<std::shared_ptr<ReviewAnnotation>> ReviewsApi::reviews_submitAnnotation(utility::string_t tenantId, utility::string_t projectId, utility::string_t queueId, utility::string_t taskId, std::shared_ptr<SubmitReviewAnnotationHttpRequest> submitReviewAnnotationHttpRequest, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xPaletteApiKey, boost::optional<utility::string_t> xPaletteProjectId, boost::optional<utility::string_t> xPaletteEnvironmentId) const
{

    // verify the required parameter 'submitReviewAnnotationHttpRequest' is set
    if (submitReviewAnnotationHttpRequest == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'submitReviewAnnotationHttpRequest' when calling ReviewsApi->reviews_submitAnnotation"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ReviewsApi->reviews_submitAnnotation does not produce any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling reviews_submitAnnotation: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling reviews_submitAnnotation: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling reviews_submitAnnotation: unsupported response type"));
        }
