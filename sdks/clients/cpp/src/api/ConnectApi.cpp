...
#include "beater-client/api/ConnectApi.h"
...
ConnectApi::ConnectApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::shared_ptr<PaletteConnectStatusResponse>> ConnectApi::connect_getPaletteConnectStatus(utility::string_t tenantId, utility::string_t projectId, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xBeaterApiKey, boost::optional<utility::string_t> xBeaterProjectId, boost::optional<utility::string_t> xBeaterEnvironmentId) const
{


    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/v1/connect/status/{tenant_id}/{project_id}");
    ...
    {
        std::shared_ptr<PaletteConnectStatusResponse> localVarResult(new PaletteConnectStatusResponse());
