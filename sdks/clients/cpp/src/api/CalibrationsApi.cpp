...
pplx::task<std::shared_ptr<CalibrationReport>> CalibrationsApi::calibrations_runCalibration(utility::string_t tenantId, utility::string_t projectId, utility::string_t datasetId, utility::string_t versionId, std::shared_ptr<RunCalibrationHttpRequest> runCalibrationHttpRequest, boost::optional<utility::string_t> authorization, boost::optional<utility::string_t> xPaletteApiKey, boost::optional<utility::string_t> xPaletteProjectId, boost::optional<utility::string_t> xPaletteEnvironmentId) const
{
