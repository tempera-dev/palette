...
pub struct PageRunSummaryItemsInner {
...
impl PageRunSummaryItemsInner {
    pub fn new(first_span_name: String, models: Vec<models::ModelRef>, project_id: String, release_ids: Vec<String>, span_count: i32, started_at: String, status: models::SpanStatus, tenant_id: String, trace_id: String) -> PageRunSummaryItemsInner {
