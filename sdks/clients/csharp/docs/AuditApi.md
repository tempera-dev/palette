...
# **ListAuditEvents**
> List&lt;AuditEvent&gt; ListAuditEvents (string tenantId, string projectId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class ListAuditEventsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AuditApi.ListAuditEvents: " + e.Message);
...
{
    Debug.Print("Exception when calling AuditApi.ListAuditEventsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
