...
> SamplingDecision DecideOnlineSampling (string tenantId, string projectId, string traceId, OnlineSamplingPolicy onlineSamplingPolicy, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class DecideOnlineSamplingExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new OnlineApi(httpClient, config, httpClientHandler);
            ...
            var onlineSamplingPolicy = new OnlineSamplingPolicy(); // OnlineSamplingPolicy | 
            ...
            {
                Debug.Print("Exception when calling OnlineApi.DecideOnlineSampling: " + e.Message);
...
#### Using the DecideOnlineSamplingWithHttpInfo variant
...
{
    Debug.Print("Exception when calling OnlineApi.DecideOnlineSamplingWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
