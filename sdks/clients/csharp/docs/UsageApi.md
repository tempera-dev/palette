...
# **GetUsageSummary**
> UsageSummary GetUsageSummary (string tenantId, string projectId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class GetUsageSummaryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UsageApi.GetUsageSummary: " + e.Message);
...
{
    Debug.Print("Exception when calling UsageApi.GetUsageSummaryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
