...
# **AddPromptVersion**
> PromptVersion AddPromptVersion (string tenantId, string projectId, string promptId, AddPromptVersionRequest addPromptVersionRequest, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class AddPromptVersionExample
    {
        public static void Main()
        {
            ...
            var promptId = "promptId_example";  // string | prompt_id
            var addPromptVersionRequest = new AddPromptVersionRequest(); // AddPromptVersionRequest | 
            ...
            {
                Debug.Print("Exception when calling PromptsApi.AddPromptVersion: " + e.Message);
...
#### Using the AddPromptVersionWithHttpInfo variant
...
{
    Debug.Print("Exception when calling PromptsApi.AddPromptVersionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="createprompt"></a>
# **CreatePrompt**
> CreatedPrompt CreatePrompt (string tenantId, string projectId, CreatePromptRequest createPromptRequest, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class CreatePromptExample
    {
        public static void Main()
        {
            ...
            var tenantId = "tenantId_example";  // string | tenant_id
            var projectId = "projectId_example";  // string | project_id
            var createPromptRequest = new CreatePromptRequest(); // CreatePromptRequest | 
            var authorization = "authorization_example";  // string? | Bearer API token for strict auth (optional) 
            var xBeaterApiKey = "xBeaterApiKey_example";  // string? | API key alternative for strict auth (optional) 
            var xBeaterProjectId = "xBeaterProjectId_example";  // string? | Strict-auth project scope (optional) 
            var xBeaterEnvironmentId = "xBeaterEnvironmentId_example";  // string? | Strict-auth environment scope (optional) 
            ...
            {
                Debug.Print("Exception when calling PromptsApi.CreatePrompt: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CreatePromptWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling PromptsApi.CreatePromptWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **DiffPromptVersions**
> PromptVersionDiff DiffPromptVersions (string tenantId, string projectId, string promptId, string from, string to, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class DiffPromptVersionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling PromptsApi.DiffPromptVersions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the DiffPromptVersionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling PromptsApi.DiffPromptVersionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getprompt"></a>
# **GetPrompt**
> Prompt GetPrompt (string tenantId, string projectId, string promptId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class GetPromptExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PromptsApi.GetPrompt: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetPromptWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling PromptsApi.GetPromptWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **ListPromptVersions**
> PromptVersionListResponse ListPromptVersions (string tenantId, string projectId, string promptId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class ListPromptVersionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling PromptsApi.ListPromptVersions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ListPromptVersionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling PromptsApi.ListPromptVersionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="listprompts"></a>
# **ListPrompts**
> PromptListResponse ListPrompts (string tenantId, string projectId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class ListPromptsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PromptsApi.ListPrompts: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ListPromptsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling PromptsApi.ListPromptsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
