...
# **CreateReviewQueue**
> ReviewQueue CreateReviewQueue (string tenantId, string projectId, CreateReviewQueueHttpRequest createReviewQueueHttpRequest, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class CreateReviewQueueExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReviewsApi.CreateReviewQueue: " + e.Message);
...
#### Using the CreateReviewQueueWithHttpInfo variant
...
{
    Debug.Print("Exception when calling ReviewsApi.CreateReviewQueueWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> ReviewTask EnqueueReviewTaskFromTrace (string tenantId, string projectId, string queueId, EnqueueReviewTaskFromTraceHttpRequest enqueueReviewTaskFromTraceHttpRequest, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class EnqueueReviewTaskFromTraceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling ReviewsApi.EnqueueReviewTaskFromTrace: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the EnqueueReviewTaskFromTraceWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling ReviewsApi.EnqueueReviewTaskFromTraceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **ListReviewTasks**
> List&lt;ReviewTask&gt; ListReviewTasks (string tenantId, string projectId, string queueId, ReviewTaskState? state = null, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class ListReviewTasksExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling ReviewsApi.ListReviewTasks: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ListReviewTasksWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling ReviewsApi.ListReviewTasksWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **projectId** | **string** | project_id |  |
| **queueId** | **string** | queue_id |  |
| **state** | [**ReviewTaskState?**](ReviewTaskState?.md) |  | [optional]  |
| **authorization** | **string?** | Bearer API token for strict auth | [optional]  |
| **xBeaterApiKey** | **string?** | API key alternative for strict auth | [optional]  |
| **xBeaterProjectId** | **string?** | Strict-auth project scope | [optional]  |
| **xBeaterEnvironmentId** | **string?** | Strict-auth environment scope | [optional]  |
...
namespace Example
{
    public class PromoteReviewAnnotationExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling ReviewsApi.PromoteReviewAnnotation: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the PromoteReviewAnnotationWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling ReviewsApi.PromoteReviewAnnotationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> ReviewAnnotation SubmitReviewAnnotation (string tenantId, string projectId, string queueId, string taskId, SubmitReviewAnnotationHttpRequest submitReviewAnnotationHttpRequest, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class SubmitReviewAnnotationExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling ReviewsApi.SubmitReviewAnnotation: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the SubmitReviewAnnotationWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling ReviewsApi.SubmitReviewAnnotationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
