...
# **DrainTraceIngested**
> TraceIngestedDrainReport DrainTraceIngested (string tenantId, string projectId, int? limit = null, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class DrainTraceIngestedExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling IngestApi.DrainTraceIngested: " + e.Message);
...
#### Using the DrainTraceIngestedWithHttpInfo variant
...
{
    Debug.Print("Exception when calling IngestApi.DrainTraceIngestedWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **DrainTraceWrites**
> TraceWriteDrainReport DrainTraceWrites (string tenantId, string projectId, int? limit = null, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class DrainTraceWritesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling IngestApi.DrainTraceWrites: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the DrainTraceWritesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.DrainTraceWritesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> IngestQueueStatus GetIngestQueueStatus (string tenantId, string projectId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class GetIngestQueueStatusExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling IngestApi.GetIngestQueueStatus: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetIngestQueueStatusWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.GetIngestQueueStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="importsource"></a>
# **ImportSource**
> IngestOutcome ImportSource (string tenantId, string projectId, string environmentId, ImportSourceHttpRequest importSourceHttpRequest, string? durability = null, string? authorization = null, string? xBeaterApiKey = null)
...
namespace Example
{
    public class ImportSourceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var tenantId = "tenantId_example";  // string | tenant_id
            var projectId = "projectId_example";  // string | project_id
            var environmentId = "environmentId_example";  // string | environment_id
            var importSourceHttpRequest = new ImportSourceHttpRequest(); // ImportSourceHttpRequest | 
            var durability = "durability_example";  // string? |  (optional) 
            var authorization = "authorization_example";  // string? | Bearer API token for strict auth (optional) 
            var xBeaterApiKey = "xBeaterApiKey_example";  // string? | API key alternative for strict auth (optional) 
            ...
            {
                Debug.Print("Exception when calling IngestApi.ImportSource: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ImportSourceWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.ImportSourceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="ingestnative"></a>
# **IngestNative**
> IngestOutcome IngestNative (NativeIngestRequest nativeIngestRequest, string? durability = null, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class IngestNativeExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new IngestApi(httpClient, config, httpClientHandler);
            var nativeIngestRequest = new NativeIngestRequest(); // NativeIngestRequest | 
            var durability = "durability_example";  // string? |  (optional) 
            var authorization = "authorization_example";  // string? | Bearer API token for strict auth (optional) 
            var xBeaterApiKey = "xBeaterApiKey_example";  // string? | API key alternative for strict auth (optional) 
            var xBeaterProjectId = "xBeaterProjectId_example";  // string? | Strict-auth project scope (optional) 
            ...
            {
                Debug.Print("Exception when calling IngestApi.IngestNative: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the IngestNativeWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.IngestNativeWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="ingestotlp"></a>
# **IngestOtlp**
> OtlpIngestOutcome IngestOtlp (string tenantId, string projectId, string environmentId, string? durability = null, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class IngestOtlpExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling IngestApi.IngestOtlp: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the IngestOtlpWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.IngestOtlpWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **ReconcileTrace**
> TraceIngestedReconcileReport ReconcileTrace (string tenantId, string projectId, string traceId, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class ReconcileTraceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling IngestApi.ReconcileTrace: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ReconcileTraceWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.ReconcileTraceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **ReplayDeadLetter**
> DeadLetterReplayReport ReplayDeadLetter (string tenantId, string projectId, string messageId, bool? resetAttempts = null, string? authorization = null, string? xBeaterApiKey = null, string? xBeaterProjectId = null, string? xBeaterEnvironmentId = null)
...
namespace Example
{
    public class ReplayDeadLetterExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var tenantId = "tenantId_example";  // string | tenant_id
            var projectId = "projectId_example";  // string | project_id
            var messageId = "messageId_example";  // string | message_id
            var resetAttempts = true;  // bool? |  (optional) 
            var authorization = "authorization_example";  // string? | Bearer API token for strict auth (optional) 
            var xBeaterApiKey = "xBeaterApiKey_example";  // string? | API key alternative for strict auth (optional) 
            var xBeaterProjectId = "xBeaterProjectId_example";  // string? | Strict-auth project scope (optional) 
            var xBeaterEnvironmentId = "xBeaterEnvironmentId_example";  // string? | Strict-auth environment scope (optional) 
            ...
            {
                Debug.Print("Exception when calling IngestApi.ReplayDeadLetter: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ReplayDeadLetterWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Debug.Print("Exception when calling IngestApi.ReplayDeadLetterWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
