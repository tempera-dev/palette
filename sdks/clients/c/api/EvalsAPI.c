...
EvalsAPI_evalsRunDeterministic(apiClient_t *apiClient, char *tenantId, char *projectId, char *datasetId, char *versionId, run_deterministic_eval_request_t *run_deterministic_eval_request, char *authorization, char *x_palette_api_key, char *x_palette_project_id, char *x_palette_environment_id)
{
    ...
    // create the path
    char *localVarPath = strdup("/v1/datasets/{tenantId}/{projectId}/{datasetId}/versions/{versionId}/evals/deterministic");
    ...
    // Path Params
    long sizeOfPathParams_tenantId = strlen(tenantId)+3 + strlen(projectId)+3 + strlen(datasetId)+3 + strlen(versionId)+3 + sizeof("{ tenantId }") - 1;
    if(tenantId == NULL) {
        goto end;
    }
    ...
    // Path Params
    long sizeOfPathParams_projectId = strlen(tenantId)+3 + strlen(projectId)+3 + strlen(datasetId)+3 + strlen(versionId)+3 + sizeof("{ projectId }") - 1;
    if(projectId == NULL) {
        goto end;
    }
    ...
    // Path Params
    long sizeOfPathParams_datasetId = strlen(tenantId)+3 + strlen(projectId)+3 + strlen(datasetId)+3 + strlen(versionId)+3 + sizeof("{ datasetId }") - 1;
    if(datasetId == NULL) {
        goto end;
    }
    ...
    // Path Params
    long sizeOfPathParams_versionId = strlen(tenantId)+3 + strlen(projectId)+3 + strlen(datasetId)+3 + strlen(versionId)+3 + sizeof("{ versionId }") - 1;
    if(versionId == NULL) {
        goto end;
    }
    char* localVarToReplace_versionId = malloc(sizeOfPathParams_versionId);
    sprintf(localVarToReplace_versionId, "{%s}", "versionId");

    localVarPath = strReplace(localVarPath, localVarToReplace_versionId, versionId);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_run_deterministic_eval_request = NULL;
    if (run_deterministic_eval_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_run_deterministic_eval_request = run_deterministic_eval_request_convertToJSON(run_deterministic_eval_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_run_deterministic_eval_request);
    ...
    //    printf("%s\n","Run a deterministic dataset evaluation");
    //}
    // uncomment below to debug the error response
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EvalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = dataset_eval_report_parseFromJSON(EvalsAPIlocalVarJSON);
        cJSON_Delete(EvalsAPIlocalVarJSON);
    ...
    free(localVarToReplace_versionId);
    ...
    if (localVarSingleItemJSON_run_deterministic_eval_request) {
        cJSON_Delete(localVarSingleItemJSON_run_deterministic_eval_request);
        localVarSingleItemJSON_run_deterministic_eval_request = NULL;
    }
...
dataset_eval_report_t*
EvalsAPI_evalsRunJudge(apiClient_t *apiClient, char *tenantId, char *projectId, char *datasetId, char *versionId, run_judge_dataset_eval_request_t *run_judge_dataset_eval_request, char *authorization, char *x_palette_api_key, char *x_palette_project_id, char *x_palette_environment_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/v1/datasets/{tenantId}/{projectId}/{datasetId}/versions/{versionId}/evals/judge");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_run_judge_dataset_eval_request = NULL;
    if (run_judge_dataset_eval_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_run_judge_dataset_eval_request = run_judge_dataset_eval_request_convertToJSON(run_judge_dataset_eval_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_run_judge_dataset_eval_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    // uncomment below to debug the error response
    //if (apiClient->response_code == 200) {
    //    printf("%s\n","Run a judge dataset evaluation");
    //}
    // uncomment below to debug the error response
    //if (apiClient->response_code == 400) {
    //    printf("%s\n","A google.rpc.Status error envelope.");
    ...
    free(keyPairHeader_x_palette_environment_id);
    if (localVarSingleItemJSON_run_judge_dataset_eval_request) {
        cJSON_Delete(localVarSingleItemJSON_run_judge_dataset_eval_request);
        localVarSingleItemJSON_run_judge_dataset_eval_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
