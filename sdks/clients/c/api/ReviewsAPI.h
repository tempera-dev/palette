...
typedef enum  { palette_api_reviewsListReviewTasks__NULL = 0, palette_api_reviewsListReviewTasks__open, palette_api_reviewsListReviewTasks__submitted, palette_api_reviewsListReviewTasks__cancelled } palette_api_reviewsListReviewTasks_state_e;
