...
ExperimentsAPI_experimentsRunDeterministic(apiClient_t *apiClient, char *tenantId, char *projectId, char *datasetId, char *versionId, run_experiment_request_t *run_experiment_request, char *authorization, char *x_palette_api_key, char *x_palette_project_id, char *x_palette_environment_id)
{
    ...
    // create the path
    char *localVarPath = strdup("/v1/experiments/{tenantId}/{projectId}/{datasetId}/versions/{versionId}/deterministic");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_run_experiment_request = NULL;
    if (run_experiment_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_run_experiment_request = run_experiment_request_convertToJSON(run_experiment_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_run_experiment_request);
    ...
    experiment_run_report_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ExperimentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = experiment_run_report_parseFromJSON(ExperimentsAPIlocalVarJSON);
        cJSON_Delete(ExperimentsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_run_experiment_request) {
        cJSON_Delete(localVarSingleItemJSON_run_experiment_request);
        localVarSingleItemJSON_run_experiment_request = NULL;
    }
...
experiment_run_report_t*
ExperimentsAPI_experimentsRunJudge(apiClient_t *apiClient, char *tenantId, char *projectId, char *datasetId, char *versionId, run_judge_experiment_request_t *run_judge_experiment_request, char *authorization, char *x_palette_api_key, char *x_palette_project_id, char *x_palette_environment_id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/v1/experiments/{tenantId}/{projectId}/{datasetId}/versions/{versionId}/judge");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_run_judge_experiment_request = NULL;
    if (run_judge_experiment_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_run_judge_experiment_request = run_judge_experiment_request_convertToJSON(run_judge_experiment_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_run_judge_experiment_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_palette_environment_id);
    if (localVarSingleItemJSON_run_judge_experiment_request) {
        cJSON_Delete(localVarSingleItemJSON_run_judge_experiment_request);
        localVarSingleItemJSON_run_judge_experiment_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
