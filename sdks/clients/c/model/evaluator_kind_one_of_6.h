...
typedef enum  { palette_api_evaluator_kind_one_of_6_TYPE_NULL = 0, palette_api_evaluator_kind_one_of_6_TYPE_llm_judge } palette_api_evaluator_kind_one_of_6_TYPE_e;

char* evaluator_kind_one_of_6_type_ToString(palette_api_evaluator_kind_one_of_6_TYPE_e type);

palette_api_evaluator_kind_one_of_6_TYPE_e evaluator_kind_one_of_6_type_FromString(char* type);
...
typedef struct evaluator_kind_one_of_6_t {
    char *model; // string
    char *rubric; // string
    palette_api_evaluator_kind_one_of_6_TYPE_e type; //enum
...
__attribute__((deprecated)) evaluator_kind_one_of_6_t *evaluator_kind_one_of_6_create(
    char *model,
    char *rubric,
    palette_api_evaluator_kind_one_of_6_TYPE_e type
);
