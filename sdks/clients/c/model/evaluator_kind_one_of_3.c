...
static evaluator_kind_one_of_3_t *evaluator_kind_one_of_3_create_internal(
    ...
    evaluator_kind_one_of_3_local_var->max_micros = max_micros;
...
cJSON *evaluator_kind_one_of_3_convertToJSON(evaluator_kind_one_of_3_t *evaluator_kind_one_of_3) {
    ...
    // evaluator_kind_one_of_3->max_micros
    if (!evaluator_kind_one_of_3->max_micros) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "max_micros", evaluator_kind_one_of_3->max_micros) == NULL) {
    goto fail; //Numeric
    }
...
evaluator_kind_one_of_3_t *evaluator_kind_one_of_3_parseFromJSON(cJSON *evaluator_kind_one_of_3JSON){
    ...
    // evaluator_kind_one_of_3->max_micros
    cJSON *max_micros = cJSON_GetObjectItemCaseSensitive(evaluator_kind_one_of_3JSON, "max_micros");
