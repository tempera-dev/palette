...
typedef enum  { palette_api_span_io_value_one_of_2_KIND_NULL = 0, palette_api_span_io_value_one_of_2_KIND_redacted } palette_api_span_io_value_one_of_2_KIND_e;
...
typedef struct span_io_value_one_of_2_t {
    palette_api_span_io_value_one_of_2_KIND_e kind; //enum
    char *reason; // string
