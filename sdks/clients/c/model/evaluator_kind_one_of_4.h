...
typedef enum  { palette_api_evaluator_kind_one_of_4_TYPE_NULL = 0, palette_api_evaluator_kind_one_of_4_TYPE_cost_budget } palette_api_evaluator_kind_one_of_4_TYPE_e;
...
typedef struct evaluator_kind_one_of_4_t {
    ...
    palette_api_evaluator_kind_one_of_4_TYPE_e type; //enum
