...
typedef enum  { palette_api_create_api_key_http_request__NULL = 0, palette_api_create_api_key_http_request__trace:write, palette_api_create_api_key_http_request__trace:read, palette_api_create_api_key_http_request__dataset:write, palette_api_create_api_key_http_request__dataset:read, palette_api_create_api_key_http_request__scenario:write, palette_api_create_api_key_http_request__scenario:read, palette_api_create_api_key_http_request__eval:run, palette_api_create_api_key_http_request__pii:unmask, palette_api_create_api_key_http_request__admin } palette_api_create_api_key_http_request__e;
