...
typedef enum  { beater_api_create_api_key_http_request__NULL = 0, beater_api_create_api_key_http_request__trace:write, beater_api_create_api_key_http_request__trace:read, beater_api_create_api_key_http_request__dataset:write, beater_api_create_api_key_http_request__dataset:read, beater_api_create_api_key_http_request__scenario:write, beater_api_create_api_key_http_request__scenario:read, beater_api_create_api_key_http_request__eval:run, beater_api_create_api_key_http_request__pii:unmask, beater_api_create_api_key_http_request__admin } beater_api_create_api_key_http_request__e;
