...
typedef enum  { beater_api_create_api_key_http_request__NULL = 0, beater_api_create_api_key_http_request__trace_write, beater_api_create_api_key_http_request__trace_read, beater_api_create_api_key_http_request__dataset_write, beater_api_create_api_key_http_request__eval_run, beater_api_create_api_key_http_request__pii_unmask, beater_api_create_api_key_http_request__admin } beater_api_create_api_key_http_request__e;
