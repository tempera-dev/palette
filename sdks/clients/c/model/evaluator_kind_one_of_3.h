...
typedef enum  { beater_api_evaluator_kind_one_of_3_TYPE_NULL = 0, beater_api_evaluator_kind_one_of_3_TYPE_cost_budget } beater_api_evaluator_kind_one_of_3_TYPE_e;
