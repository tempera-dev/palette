...
typedef enum { palette_api_review_task_state__NULL = 0, palette_api_review_task_state__open, palette_api_review_task_state__submitted, palette_api_review_task_state__cancelled } palette_api_review_task_state__e;
