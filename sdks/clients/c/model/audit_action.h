...
typedef enum { beater_api_audit_action__NULL = 0, beater_api_audit_action__pii_unmask, beater_api_audit_action__connector_tool_invoke, beater_api_audit_action__api_key_create, beater_api_audit_action__api_key_revoke, beater_api_audit_action__provider_secret_create, beater_api_audit_action__provider_secret_revoke } beater_api_audit_action__e;
