...
typedef enum  { palette_api_evaluator_kind_one_of_10_TYPE_NULL = 0, palette_api_evaluator_kind_one_of_10_TYPE_browser_recovery } palette_api_evaluator_kind_one_of_10_TYPE_e;
...
typedef struct evaluator_kind_one_of_10_t {
    palette_api_evaluator_kind_one_of_10_TYPE_e type; //enum
