...
typedef enum  { beater_api_evaluator_kind_one_of_8_TYPE_NULL = 0, beater_api_evaluator_kind_one_of_8_TYPE_browser_grounding } beater_api_evaluator_kind_one_of_8_TYPE_e;
