...
typedef enum  { beater_api_api_key_created_response__NULL = 0, beater_api_api_key_created_response__trace:write, beater_api_api_key_created_response__trace:read, beater_api_api_key_created_response__dataset:write, beater_api_api_key_created_response__dataset:read, beater_api_api_key_created_response__scenario:write, beater_api_api_key_created_response__scenario:read, beater_api_api_key_created_response__eval:run, beater_api_api_key_created_response__pii:unmask, beater_api_api_key_created_response__admin } beater_api_api_key_created_response__e;
