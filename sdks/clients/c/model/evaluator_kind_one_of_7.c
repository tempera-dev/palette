...
static evaluator_kind_one_of_7_t *evaluator_kind_one_of_7_create_internal(
    ...
    evaluator_kind_one_of_7_local_var->max_steps = max_steps;
...
cJSON *evaluator_kind_one_of_7_convertToJSON(evaluator_kind_one_of_7_t *evaluator_kind_one_of_7) {
    ...
    // evaluator_kind_one_of_7->max_steps
    if (!evaluator_kind_one_of_7->max_steps) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "max_steps", evaluator_kind_one_of_7->max_steps) == NULL) {
    goto fail; //Numeric
    }
...
evaluator_kind_one_of_7_t *evaluator_kind_one_of_7_parseFromJSON(cJSON *evaluator_kind_one_of_7JSON){
    ...
    // evaluator_kind_one_of_7->max_steps
    cJSON *max_steps = cJSON_GetObjectItemCaseSensitive(evaluator_kind_one_of_7JSON, "max_steps");
