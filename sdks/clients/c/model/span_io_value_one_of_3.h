...
typedef enum  { palette_api_span_io_value_one_of_3_KIND_NULL = 0, palette_api_span_io_value_one_of_3_KIND_missing } palette_api_span_io_value_one_of_3_KIND_e;
...
typedef struct span_io_value_one_of_3_t {
    palette_api_span_io_value_one_of_3_KIND_e kind; //enum
