...
class ProviderSecretsApi:
    ...
    def provider_secrets_create_provider_secret(
        ...
        create_provider_secret_http_request: CreateProviderSecretHttpRequest,
        ...
        :type project_id: str
        :param create_provider_secret_http_request: (required)
        :type create_provider_secret_http_request: CreateProviderSecretHttpRequest
    ...
    def _provider_secrets_create_provider_secret_serialize(
        ...
        tenant_id,
        project_id,
        create_provider_secret_http_request,
        authorization,
        x_beater_api_key,
        x_beater_project_id,
        ...
        if create_provider_secret_http_request is not None:
            _body_params = create_provider_secret_http_request
    ...
    def provider_secrets_revoke_provider_secret(
        ...
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        provider_secret_id: Annotated[StrictStr, Field(description="provider_secret_id")],
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
        x_beater_api_key: Annotated[Optional[StrictStr], Field(description="API key alternative for strict auth")] = None,
        x_beater_project_id: Annotated[Optional[StrictStr], Field(description="Strict-auth project scope")] = None,
        x_beater_environment_id: Annotated[Optional[StrictStr], Field(description="Strict-auth environment scope")] = None,
        ...
        :param project_id: project_id (required)
        :type project_id: str
        :param provider_secret_id: provider_secret_id (required)
        :type provider_secret_id: str
        :param authorization: Bearer API token for strict auth
        :type authorization: str
        :param x_beater_api_key: API key alternative for strict auth
        :type x_beater_api_key: str
