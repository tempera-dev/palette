...
class JudgeApi:
    ...
    def judge_evaluate_judge(
        ...
        run_judge_eval_http_request: RunJudgeEvalHttpRequest,
        ...
        :type project_id: str
        :param run_judge_eval_http_request: (required)
        :type run_judge_eval_http_request: RunJudgeEvalHttpRequest
    ...
    def _judge_evaluate_judge_serialize(
        ...
        if run_judge_eval_http_request is not None:
            _body_params = run_judge_eval_http_request
