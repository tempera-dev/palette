...
class OnlineApi:
    ...
    def online_decide_online_sampling(
        ...
        online_sampling_policy: OnlineSamplingPolicy,
        ...
        :type trace_id: str
        :param online_sampling_policy: (required)
        :type online_sampling_policy: OnlineSamplingPolicy
        ...
        _param = self._online_decide_online_sampling_serialize(
            ...
            trace_id=trace_id,
            online_sampling_policy=online_sampling_policy,
    ...
    def _online_decide_online_sampling_serialize(
        ...
        if online_sampling_policy is not None:
            _body_params = online_sampling_policy
