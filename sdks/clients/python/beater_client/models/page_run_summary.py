...
class PageRunSummary(BaseModel):
    """
    PageRunSummary
    """ # noqa: E501
    items: List[PageRunSummaryItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PageRunSummaryItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
