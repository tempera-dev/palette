...
class GateComparisonResponse(BaseModel):
    """
    The held-out Test-split gate comparison.
    """ # noqa: E501
    baseline_mean: Union[StrictFloat, StrictInt] = Field(description="Mean baseline score on the Test split.")
    ...
    __properties: ClassVar[List[str]] = ["baseline_mean", "candidate_mean", "ci_high", "ci_low", "decision", "delta", "p_value", "sample_size"]
