...
class Signature(BaseModel):
    ...
    """ # noqa: E501
    hash: StrictStr = Field(description="Stable sha256 hash of the ordered shingles.")
    shingles: List[StrictStr] = Field(description="Ordered `(kind|status)` shingles of failing spans.")
    __properties: ClassVar[List[str]] = ["hash", "shingles"]
