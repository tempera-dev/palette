...
class PromptTemplate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["body", "tags", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": obj.get("body"),
            "tags": obj.get("tags"),
            "variables": [PromptVariable.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
