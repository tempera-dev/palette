...
class ConnectorListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nextPageToken", "toolkits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "toolkits": [Toolkit.from_dict(_item) for _item in obj["toolkits"]] if obj.get("toolkits") is not None else None
        })
        return _obj
