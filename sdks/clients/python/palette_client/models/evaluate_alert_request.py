...
class EvaluateAlertRequest(BaseModel):
    ...
    input: AlertInput
    policy: AlertPolicy
    __properties: ClassVar[List[str]] = ["input", "policy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": AlertInput.from_dict(obj["input"]) if obj.get("input") is not None else None,
            "policy": AlertPolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
