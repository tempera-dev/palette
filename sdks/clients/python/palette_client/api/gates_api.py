...
class GatesApi:
    ...
    def gates_create(
        ...
        _param = self._gates_create_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def gates_create_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        create_gate_request: CreateGateRequest,
    ...
    @validate_call
    def gates_create_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        create_gate_request: CreateGateRequest,
    ...
    def gates_run(
        ...
        _param = self._gates_run_serialize(
            tenant_id=tenant_id,
            project_id=project_id,
            gate_id=gate_id,
    ...
    @validate_call
    def gates_run_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        gate_id: Annotated[StrictStr, Field(description="gate_id")],
