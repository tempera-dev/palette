...
class OnlineApi:
    ...
    def online_decide_sampling(
        ...
        _param = self._online_decide_sampling_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def online_decide_sampling_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        trace_id: Annotated[StrictStr, Field(description="trace_id")],
    ...
    @validate_call
    def online_decide_sampling_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        trace_id: Annotated[StrictStr, Field(description="trace_id")],
    ...
    def _online_decide_sampling_serialize(
        self,
        tenant_id,
        project_id,
        trace_id,
