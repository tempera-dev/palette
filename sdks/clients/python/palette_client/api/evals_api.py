...
class EvalsApi:
    ...
    def evals_run_deterministic(
        ...
        _param = self._evals_run_deterministic_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def evals_run_deterministic_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        dataset_id: Annotated[StrictStr, Field(description="dataset_id")],
    ...
    @validate_call
    def evals_run_deterministic_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        dataset_id: Annotated[StrictStr, Field(description="dataset_id")],
    ...
    def _evals_run_deterministic_serialize(
        self,
        tenant_id,
        project_id,
        dataset_id,
    ...
    def evals_run_judge(
        ...
        _param = self._evals_run_judge_serialize(
            tenant_id=tenant_id,
            project_id=project_id,
            dataset_id=dataset_id,
            version_id=version_id,
    ...
    @validate_call
    def evals_run_judge_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        dataset_id: Annotated[StrictStr, Field(description="dataset_id")],
    ...
    @validate_call
    def evals_run_judge_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        dataset_id: Annotated[StrictStr, Field(description="dataset_id")],
    ...
    def _evals_run_judge_serialize(
        self,
        tenant_id,
        project_id,
        dataset_id,
