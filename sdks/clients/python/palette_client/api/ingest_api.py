...
class IngestApi:
    ...
    def ingest_otlp_json_collector(
        ...
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
        x_palette_api_key: Annotated[Optional[StrictStr], Field(description="API key alternative for strict auth")] = None,
        x_palette_tenant_id: Annotated[Optional[StrictStr], Field(description="Tenant scope override for collector-style OTLP JSON")] = None,
        x_palette_project_id: Annotated[Optional[StrictStr], Field(description="Project scope override for collector-style OTLP JSON")] = None,
        x_palette_environment_id: Annotated[Optional[StrictStr], Field(description="Environment scope override for collector-style OTLP JSON")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_palette_api_key: API key alternative for strict auth
        :type x_palette_api_key: str
        :param x_palette_tenant_id: Tenant scope override for collector-style OTLP JSON
        :type x_palette_tenant_id: str
        :param x_palette_project_id: Project scope override for collector-style OTLP JSON
        :type x_palette_project_id: str
        :param x_palette_environment_id: Environment scope override for collector-style OTLP JSON
        :type x_palette_environment_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._ingest_otlp_json_collector_serialize(
            ...
            authorization=authorization,
            x_palette_api_key=x_palette_api_key,
            x_palette_tenant_id=x_palette_tenant_id,
            x_palette_project_id=x_palette_project_id,
            x_palette_environment_id=x_palette_environment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _ingest_otlp_json_collector_serialize(
        ...
        if x_palette_api_key is not None:
            _header_params['x-palette-api-key'] = x_palette_api_key
        if x_palette_tenant_id is not None:
            _header_params['x-palette-tenant-id'] = x_palette_tenant_id
        if x_palette_project_id is not None:
            _header_params['x-palette-project-id'] = x_palette_project_id
        if x_palette_environment_id is not None:
            _header_params['x-palette-environment-id'] = x_palette_environment_id
