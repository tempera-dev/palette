...
class EvalResultsApi:
    ...
    @validate_call
    def eval_results_get_tempera_evidence(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        kind: Annotated[StrictStr, Field(description="result_bundle or ab_decision")],
        external_id: Annotated[StrictStr, Field(description="Bundle or experiment id")],
        ...
        :type kind: str
        :param external_id: Bundle or experiment id (required)
        ...
        _param = self._eval_results_get_tempera_evidence_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def eval_results_get_tempera_evidence_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        kind: Annotated[StrictStr, Field(description="result_bundle or ab_decision")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemperaEvidenceReceipt]:
        """eval_results_get_tempera_evidence
    ...
    @validate_call
    def eval_results_get_tempera_evidence_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        kind: Annotated[StrictStr, Field(description="result_bundle or ab_decision")],
    ...
    def _eval_results_get_tempera_evidence_serialize(
        self,
        tenant_id,
        project_id,
        kind,
    ...
    @validate_call
    def eval_results_import_tempera_bundle(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        import_tempera_evidence_request: ImportTemperaEvidenceRequest,
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
        x_palette_api_key: Annotated[Optional[StrictStr], Field(description="API key alternative for strict auth")] = None,
        x_palette_project_id: Annotated[Optional[StrictStr], Field(description="Strict-auth project scope")] = None,
        x_palette_environment_id: Annotated[Optional[StrictStr], Field(description="Strict-auth environment scope")] = None,
        ...
        :param project_id: project_id (required)
        :type project_id: str
        :param import_tempera_evidence_request: (required)
        :type import_tempera_evidence_request: ImportTemperaEvidenceRequest
        :param authorization: Bearer API token for strict auth
        :type authorization: str
        :param x_palette_api_key: API key alternative for strict auth
        :type x_palette_api_key: str
        ...
        _param = self._eval_results_import_tempera_bundle_serialize(
            tenant_id=tenant_id,
            project_id=project_id,
            import_tempera_evidence_request=import_tempera_evidence_request,
            authorization=authorization,
            x_palette_api_key=x_palette_api_key,
            x_palette_project_id=x_palette_project_id,
            x_palette_environment_id=x_palette_environment_id,
    ...
    @validate_call
    def eval_results_import_tempera_bundle_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        import_tempera_evidence_request: ImportTemperaEvidenceRequest,
    ...
    @validate_call
    def eval_results_import_tempera_bundle_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        import_tempera_evidence_request: ImportTemperaEvidenceRequest,
    ...
    def _eval_results_import_tempera_bundle_serialize(
        self,
        tenant_id,
        project_id,
        import_tempera_evidence_request,
        authorization,
        x_palette_api_key,
        x_palette_project_id,
        x_palette_environment_id,
        ...
        # process the form parameters
        # process the body parameter
        if import_tempera_evidence_request is not None:
            _body_params = import_tempera_evidence_request
    ...
    @validate_call
    def eval_results_record_tempera_decision(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        import_tempera_evidence_request: ImportTemperaEvidenceRequest,
        ...
        _param = self._eval_results_record_tempera_decision_serialize(
            tenant_id=tenant_id,
            project_id=project_id,
            import_tempera_evidence_request=import_tempera_evidence_request,
            authorization=authorization,
    ...
    @validate_call
    def eval_results_record_tempera_decision_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        import_tempera_evidence_request: ImportTemperaEvidenceRequest,
    ...
    @validate_call
    def eval_results_record_tempera_decision_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        import_tempera_evidence_request: ImportTemperaEvidenceRequest,
    ...
    def _eval_results_record_tempera_decision_serialize(
        self,
        tenant_id,
        project_id,
        import_tempera_evidence_request,
