...
class SpansApi:
    ...
    def spans_get(
        ...
        _param = self._spans_get_serialize(
            tenant_id=tenant_id,
            trace_id=trace_id,
            span_id=span_id,
            unmask=unmask,
    ...
    @validate_call
    def spans_get_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        trace_id: Annotated[StrictStr, Field(description="trace_id")],
        span_id: Annotated[StrictStr, Field(description="span_id")],
    ...
    def spans_get_io(
        ...
        _param = self._spans_get_io_serialize(
            tenant_id=tenant_id,
            trace_id=trace_id,
            span_id=span_id,
            unmask=unmask,
    ...
    @validate_call
    def spans_get_io_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        trace_id: Annotated[StrictStr, Field(description="trace_id")],
        span_id: Annotated[StrictStr, Field(description="span_id")],
    ...
    @validate_call
    def spans_get_io_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        trace_id: Annotated[StrictStr, Field(description="trace_id")],
        span_id: Annotated[StrictStr, Field(description="span_id")],
