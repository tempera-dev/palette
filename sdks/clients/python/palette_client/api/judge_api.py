...
class JudgeApi:
    ...
    def judge_evaluate(
        ...
        _param = self._judge_evaluate_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def judge_evaluate_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        run_judge_eval_http_request: RunJudgeEvalHttpRequest,
    ...
    @validate_call
    def judge_evaluate_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        run_judge_eval_http_request: RunJudgeEvalHttpRequest,
    ...
    @validate_call
    def judge_list_ledger_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
    ...
    @validate_call
    def judge_list_ledger_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
    ...
    def _judge_list_ledger_serialize(
        self,
        tenant_id,
        project_id,
        authorization,
