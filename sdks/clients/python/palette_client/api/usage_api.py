...
class UsageApi:
    ...
    def usage_get_summary(
        ...
        _param = self._usage_get_summary_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def usage_get_summary_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
    ...
    @validate_call
    def usage_get_summary_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="tenant_id")],
        project_id: Annotated[StrictStr, Field(description="project_id")],
        authorization: Annotated[Optional[StrictStr], Field(description="Bearer API token for strict auth")] = None,
    ...
    def _usage_get_summary_serialize(
        self,
        tenant_id,
        project_id,
        authorization,
