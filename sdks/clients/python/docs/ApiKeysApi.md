# palette_client.ApiKeysApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_keys_create**](ApiKeysApi.md#api_keys_create) | **POST** /v1/api-keys/{tenantId}/{projectId}/{environmentId} |
[**api_keys_revoke**](ApiKeysApi.md#api_keys_revoke) | **POST** /v1/api-keys/{tenantId}/{projectId}/{environmentId}/{apiKeyId}/revoke |
...
with palette_client.ApiClient(configuration) as api_client:
    ...
    api_instance = palette_client.ApiKeysApi(api_client)
    ...
    create_api_key_http_request = palette_client.CreateApiKeyHttpRequest() # CreateApiKeyHttpRequest |
