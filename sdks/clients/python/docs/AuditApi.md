...
# **list_audit_events**
> List[AuditEvent] list_audit_events(tenant_id, project_id, authorization=authorization, x_beater_api_key=x_beater_api_key, x_beater_project_id=x_beater_project_id, x_beater_environment_id=x_beater_environment_id)
...
with beater_client.ApiClient(configuration) as api_client:
    ...
    api_instance = beater_client.AuditApi(api_client)
    ...
    try:
        api_response = api_instance.list_audit_events(tenant_id, project_id, authorization=authorization, x_beater_api_key=x_beater_api_key, x_beater_project_id=x_beater_project_id, x_beater_environment_id=x_beater_environment_id)
        print("The response of AuditApi->list_audit_events:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuditApi->list_audit_events: %s\n" % e)
```
