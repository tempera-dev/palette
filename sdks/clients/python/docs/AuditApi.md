...
> List[AuditEvent] audit_list_audit_events(tenant_id, project_id, authorization=authorization, x_beater_api_key=x_beater_api_key, x_beater_project_id=x_beater_project_id, x_beater_environment_id=x_beater_environment_id)
...
with beater_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.audit_list_audit_events(tenant_id, project_id, authorization=authorization, x_beater_api_key=x_beater_api_key, x_beater_project_id=x_beater_project_id, x_beater_environment_id=x_beater_environment_id)
