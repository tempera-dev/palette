...
func (r ApiConnectGetPaletteConnectStatusRequest) XBeaterApiKey(xBeaterApiKey string) ApiConnectGetPaletteConnectStatusRequest {
	r.xBeaterApiKey = &xBeaterApiKey
	return r
}

// Strict-auth project scope
func (r ApiConnectGetPaletteConnectStatusRequest) XBeaterProjectId(xBeaterProjectId string) ApiConnectGetPaletteConnectStatusRequest {
	r.xBeaterProjectId = &xBeaterProjectId
	return r
}

// Strict-auth environment scope
func (r ApiConnectGetPaletteConnectStatusRequest) XBeaterEnvironmentId(xBeaterEnvironmentId string) ApiConnectGetPaletteConnectStatusRequest {
...
func (a *ConnectAPIService) ConnectGetPaletteConnectStatusExecute(r ApiConnectGetPaletteConnectStatusRequest) (*PaletteConnectStatusResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connect/status/{tenant_id}/{project_id}"
