...
func (a *ConnectorsAPIService) ConnectorsConnectExecute(r ApiConnectorsConnectRequest) (*ConnectionLink, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectors/{tenantId}/{projectId}/connect"
...
func (a *ConnectorsAPIService) ConnectorsGetSkillsExecute(r ApiConnectorsGetSkillsRequest) (*ConnectorSkillsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectors/{tenantId}/{projectId}/skills"
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", url.PathEscape(parameterValueToString(r.tenantId, "tenantId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
func (a *ConnectorsAPIService) ConnectorsInvokeToolExecute(r ApiConnectorsInvokeToolRequest) (*ToolExecution, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectors/{tenantId}/{projectId}/invoke"
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", url.PathEscape(parameterValueToString(r.tenantId, "tenantId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
func (a *ConnectorsAPIService) ConnectorsListExecute(r ApiConnectorsListRequest) (*ConnectorListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectors/{tenantId}/{projectId}"
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", url.PathEscape(parameterValueToString(r.tenantId, "tenantId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
func (a *ConnectorsAPIService) ConnectorsListToolsExecute(r ApiConnectorsListToolsRequest) (*ConnectorToolListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectors/{tenantId}/{projectId}/tools"
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", url.PathEscape(parameterValueToString(r.tenantId, "tenantId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
func (a *ConnectorsAPIService) ConnectorsStatusExecute(r ApiConnectorsStatusRequest) (*ConnectionStatus, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/connectors/{tenantId}/{projectId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", url.PathEscape(parameterValueToString(r.tenantId, "tenantId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
