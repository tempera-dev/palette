...
type ExperimentComparison struct {
	AdjustedAlpha float64 `json:"adjustedAlpha"`
	...
	RequiredN NullableInt32 `json:"requiredN,omitempty"`
...
func (o ExperimentComparison) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["adjustedAlpha"] = o.AdjustedAlpha
	toSerialize["baselineMean"] = o.BaselineMean
	toSerialize["candidateMean"] = o.CandidateMean
	...
	if o.RequiredN.IsSet() {
		toSerialize["requiredN"] = o.RequiredN.Get()
	}
