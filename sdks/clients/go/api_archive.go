...
func (r ApiArchiveArchiveTraceRequest) XPaletteApiKey(xPaletteApiKey string) ApiArchiveArchiveTraceRequest {
	r.xPaletteApiKey = &xPaletteApiKey
	return r
}

// Strict-auth project scope
func (r ApiArchiveArchiveTraceRequest) XPaletteProjectId(xPaletteProjectId string) ApiArchiveArchiveTraceRequest {
	r.xPaletteProjectId = &xPaletteProjectId
	return r
}

// Strict-auth environment scope
func (r ApiArchiveArchiveTraceRequest) XPaletteEnvironmentId(xPaletteEnvironmentId string) ApiArchiveArchiveTraceRequest {
