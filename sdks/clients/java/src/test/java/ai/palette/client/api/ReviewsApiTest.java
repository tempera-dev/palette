...
public class ReviewsApiTest {
    ...
    public void reviewsListTasksTest() throws ApiException {
        ...
        String xPaletteProjectId = null;
        String xPaletteEnvironmentId = null;
        ReviewTaskListResponse response =
        api.reviewsListTasks(tenantId, projectId, queueId, state, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
