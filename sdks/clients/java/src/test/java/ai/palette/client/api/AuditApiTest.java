...
public class AuditApiTest {
    ...
    public void auditListTest() throws ApiException {
        ...
        AuditEventListResponse response =
        api.auditList(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
