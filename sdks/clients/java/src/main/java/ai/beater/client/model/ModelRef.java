...
@JsonPropertyOrder({
  ...
  ModelRef.JSON_PROPERTY_PROVIDER
})
...
public class ModelRef {
  ...
  public ModelRef name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ModelRef provider(@javax.annotation.Nonnull String provider) {
  ...
  /**
   * Return true if this ModelRef object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, modelRef.name) &&
        Objects.equals(this.provider, modelRef.provider);
  }
