 ...
 */
@JsonPropertyOrder({
  CreateDatasetRequest.JSON_PROPERTY_NAME
})
...
public class CreateDatasetRequest {
  ...
  public CreateDatasetRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this CreateDatasetRequest object is equal to o.
   */
  @Override
