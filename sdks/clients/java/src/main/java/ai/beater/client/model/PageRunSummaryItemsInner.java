 ...
 */
@JsonPropertyOrder({
  PageRunSummaryItemsInner.JSON_PROPERTY_DURATION_MS,
  PageRunSummaryItemsInner.JSON_PROPERTY_ENDED_AT,
  PageRunSummaryItemsInner.JSON_PROPERTY_FIRST_SPAN_NAME,
  PageRunSummaryItemsInner.JSON_PROPERTY_MODELS,
  PageRunSummaryItemsInner.JSON_PROPERTY_PROJECT_ID,
  PageRunSummaryItemsInner.JSON_PROPERTY_RELEASE_IDS,
  PageRunSummaryItemsInner.JSON_PROPERTY_SPAN_COUNT,
  PageRunSummaryItemsInner.JSON_PROPERTY_STARTED_AT,
  PageRunSummaryItemsInner.JSON_PROPERTY_STATUS,
  PageRunSummaryItemsInner.JSON_PROPERTY_TENANT_ID,
  PageRunSummaryItemsInner.JSON_PROPERTY_TOTAL_COST,
  PageRunSummaryItemsInner.JSON_PROPERTY_TRACE_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class PageRunSummaryItemsInner {
  ...
  public PageRunSummaryItemsInner() { 
  }

  public PageRunSummaryItemsInner durationMs(@javax.annotation.Nullable Long durationMs) {
  ...
  public PageRunSummaryItemsInner endedAt(@javax.annotation.Nullable OffsetDateTime endedAt) {
  ...
  public PageRunSummaryItemsInner firstSpanName(@javax.annotation.Nonnull String firstSpanName) {
  ...
  public PageRunSummaryItemsInner models(@javax.annotation.Nonnull List<ModelRef> models) {
    this.models = models;
    return this;
  }

  public PageRunSummaryItemsInner addModelsItem(ModelRef modelsItem) {
    if (this.models == null) {
  ...
  public PageRunSummaryItemsInner projectId(@javax.annotation.Nonnull String projectId) {
  ...
  public PageRunSummaryItemsInner releaseIds(@javax.annotation.Nonnull List<String> releaseIds) {
    this.releaseIds = releaseIds;
    return this;
  }

  public PageRunSummaryItemsInner addReleaseIdsItem(String releaseIdsItem) {
  ...
  public PageRunSummaryItemsInner spanCount(@javax.annotation.Nonnull Integer spanCount) {
  ...
  public PageRunSummaryItemsInner startedAt(@javax.annotation.Nonnull OffsetDateTime startedAt) {
  ...
  public PageRunSummaryItemsInner status(@javax.annotation.Nonnull SpanStatus status) {
    this.status = status;
    return this;
  }
  ...
  public PageRunSummaryItemsInner tenantId(@javax.annotation.Nonnull String tenantId) {
  ...
  public PageRunSummaryItemsInner totalCost(@javax.annotation.Nullable Money totalCost) {
  ...
  public PageRunSummaryItemsInner traceId(@javax.annotation.Nonnull String traceId) {
  ...
  /**
   * Return true if this Page_RunSummary_items_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageRunSummaryItemsInner pageRunSummaryItemsInner = (PageRunSummaryItemsInner) o;
    return equalsNullable(this.durationMs, pageRunSummaryItemsInner.durationMs) &&
        equalsNullable(this.endedAt, pageRunSummaryItemsInner.endedAt) &&
        Objects.equals(this.firstSpanName, pageRunSummaryItemsInner.firstSpanName) &&
        Objects.equals(this.models, pageRunSummaryItemsInner.models) &&
        Objects.equals(this.projectId, pageRunSummaryItemsInner.projectId) &&
        Objects.equals(this.releaseIds, pageRunSummaryItemsInner.releaseIds) &&
        Objects.equals(this.spanCount, pageRunSummaryItemsInner.spanCount) &&
        Objects.equals(this.startedAt, pageRunSummaryItemsInner.startedAt) &&
        Objects.equals(this.status, pageRunSummaryItemsInner.status) &&
        Objects.equals(this.tenantId, pageRunSummaryItemsInner.tenantId) &&
        equalsNullable(this.totalCost, pageRunSummaryItemsInner.totalCost) &&
        Objects.equals(this.traceId, pageRunSummaryItemsInner.traceId);
  }
