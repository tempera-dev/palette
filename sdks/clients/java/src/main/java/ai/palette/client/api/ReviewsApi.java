...
public class ReviewsApi {
   ...
   * @param pageSize Maximum number of review tasks to return. Zero selects the server default; values above the service maximum are coerced to that maximum. (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public ReviewTaskListResponse reviewsListTasks(String tenantId, String projectId, String queueId, ReviewTaskState state, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<ReviewTaskListResponse> localVarResponse = reviewsListTasksWithHttpInfo(tenantId, projectId, queueId, state, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    return localVarResponse.getData();
  }
   ...
   * @param xPaletteProjectId Strict-auth project scope (optional)
   * @param xPaletteEnvironmentId Strict-auth environment scope (optional)
   * @return ApiResponse&lt;ReviewTaskListResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ReviewTaskListResponse> reviewsListTasksWithHttpInfo(String tenantId, String projectId, String queueId, ReviewTaskState state, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = reviewsListTasksRequestBuilder(tenantId, projectId, queueId, state, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<ReviewTaskListResponse>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<ReviewTaskListResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ReviewTaskListResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder reviewsListTasksRequestBuilder(String tenantId, String projectId, String queueId, ReviewTaskState state, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
