...
public class ArchiveApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ArchiveQueryResponse archiveQuerySpans(String tenantId, String projectId, String environmentId, String traceId, String spanId, String kind, String status, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<ArchiveQueryResponse> localVarResponse = archiveQuerySpansWithHttpInfo(tenantId, projectId, environmentId, traceId, spanId, kind, status, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<ArchiveQueryResponse> archiveQuerySpansWithHttpInfo(String tenantId, String projectId, String environmentId, String traceId, String spanId, String kind, String status, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = archiveQuerySpansRequestBuilder(tenantId, projectId, environmentId, traceId, spanId, kind, status, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder archiveQuerySpansRequestBuilder(String tenantId, String projectId, String environmentId, String traceId, String spanId, String kind, String status, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
