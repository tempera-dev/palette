...
import ai.palette.client.model.RunSummary;
 ...
 */
@JsonPropertyOrder({
  TraceListResponse.JSON_PROPERTY_NEXT_PAGE_TOKEN,
  TraceListResponse.JSON_PROPERTY_RUNS
})
...
public class TraceListResponse {
  ...
  public TraceListResponse nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public TraceListResponse runs(@javax.annotation.Nonnull List<RunSummary> runs) {
    this.runs = runs;
    return this;
  }

  public TraceListResponse addRunsItem(RunSummary runsItem) {
    if (this.runs == null) {
  ...
  /**
   * Return true if this TraceListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.nextPageToken, traceListResponse.nextPageToken) &&
        Objects.equals(this.runs, traceListResponse.runs);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(nextPageToken), runs);
  }
