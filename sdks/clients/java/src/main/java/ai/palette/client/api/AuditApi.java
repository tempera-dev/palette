...
public class AuditApi {
   ...
   */
  public AuditEventListResponse auditList(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<AuditEventListResponse> localVarResponse = auditListWithHttpInfo(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
   ...
   * @param xPaletteProjectId Strict-auth project scope (optional)
   * @param xPaletteEnvironmentId Strict-auth environment scope (optional)
   * @return ApiResponse&lt;AuditEventListResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AuditEventListResponse> auditListWithHttpInfo(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = auditListRequestBuilder(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<AuditEventListResponse>(
        ...
        return new ApiResponse<AuditEventListResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<AuditEventListResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder auditListRequestBuilder(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
