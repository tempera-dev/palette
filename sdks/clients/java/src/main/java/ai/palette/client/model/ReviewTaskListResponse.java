 ...
 */
@JsonPropertyOrder({
  ReviewTaskListResponse.JSON_PROPERTY_NEXT_PAGE_TOKEN,
  ReviewTaskListResponse.JSON_PROPERTY_TASKS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class ReviewTaskListResponse {
  ...
  public ReviewTaskListResponse() {
  }

  public ReviewTaskListResponse nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public ReviewTaskListResponse tasks(@javax.annotation.Nonnull List<ReviewTask> tasks) {
    this.tasks = tasks;
    return this;
  }

  public ReviewTaskListResponse addTasksItem(ReviewTask tasksItem) {
    if (this.tasks == null) {
  ...
  public List<ReviewTask> getTasks() {
    return tasks;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TASKS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTasks(@javax.annotation.Nonnull List<ReviewTask> tasks) {
    this.tasks = tasks;
  }


  /**
   * Return true if this ReviewTaskListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ReviewTaskListResponse reviewTaskListResponse = (ReviewTaskListResponse) o;
    return equalsNullable(this.nextPageToken, reviewTaskListResponse.nextPageToken) &&
        Objects.equals(this.tasks, reviewTaskListResponse.tasks);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(nextPageToken), tasks);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReviewTaskListResponse {\n");
