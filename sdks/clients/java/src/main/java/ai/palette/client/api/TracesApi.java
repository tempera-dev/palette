...
public class TracesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public TraceListResponse tracesList(String tenantId, String projectId, String environmentId, String traceId, String kind, String status, String startedAfter, String startedBefore, String model, String release, Long minCostMicros, Long maxCostMicros, Long minLatencyMs, Long maxLatencyMs, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<TraceListResponse> localVarResponse = tracesListWithHttpInfo(tenantId, projectId, environmentId, traceId, kind, status, startedAfter, startedBefore, model, release, minCostMicros, maxCostMicros, minLatencyMs, maxLatencyMs, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    return localVarResponse.getData();
  }
   ...
   * @param xPaletteProjectId Strict-auth project scope (optional)
   * @param xPaletteEnvironmentId Strict-auth environment scope (optional)
   * @return ApiResponse&lt;TraceListResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<TraceListResponse> tracesListWithHttpInfo(String tenantId, String projectId, String environmentId, String traceId, String kind, String status, String startedAfter, String startedBefore, String model, String release, Long minCostMicros, Long maxCostMicros, Long minLatencyMs, Long maxLatencyMs, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = tracesListRequestBuilder(tenantId, projectId, environmentId, traceId, kind, status, startedAfter, startedBefore, model, release, minCostMicros, maxCostMicros, minLatencyMs, maxLatencyMs, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<TraceListResponse>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<TraceListResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<TraceListResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
