...
public class JudgeApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public JudgeLedgerListResponse judgeListLedger(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<JudgeLedgerListResponse> localVarResponse = judgeListLedgerWithHttpInfo(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    return localVarResponse.getData();
  }
   ...
   * @param xPaletteProjectId Strict-auth project scope (optional)
   * @param xPaletteEnvironmentId Strict-auth environment scope (optional)
   * @return ApiResponse&lt;JudgeLedgerListResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<JudgeLedgerListResponse> judgeListLedgerWithHttpInfo(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = judgeListLedgerRequestBuilder(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<JudgeLedgerListResponse>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<JudgeLedgerListResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<JudgeLedgerListResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder judgeListLedgerRequestBuilder(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
