...
public class ConnectorsApi {
   ...
   * @param tenantId tenant_id (required)
   * @param projectId project_id (required)
   * @param pageSize Maximum number of apps to return. Zero selects the server default. (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public ConnectorListResponse connectorsList(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<ConnectorListResponse> localVarResponse = connectorsListWithHttpInfo(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    return localVarResponse.getData();
  }
   ...
   * @param xPaletteProjectId Strict-auth project scope (optional)
   * @param xPaletteEnvironmentId Strict-auth environment scope (optional)
   * @return ApiResponse&lt;ConnectorListResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ConnectorListResponse> connectorsListWithHttpInfo(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = connectorsListRequestBuilder(tenantId, projectId, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<ConnectorListResponse>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<ConnectorListResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ConnectorListResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder connectorsListRequestBuilder(String tenantId, String projectId, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
   ...
   * @param pageSize Maximum number of tools to return. Zero selects the server default. (optional)
   * @param pageToken Opaque continuation token returned by the preceding list request. (optional)
   * @param authorization Bearer API token for strict auth (optional)
   * @param xPaletteApiKey API key alternative for strict auth (optional)
   * @param xPaletteProjectId Strict-auth project scope (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public ConnectorToolListResponse connectorsListTools(String tenantId, String projectId, String toolkit, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    ApiResponse<ConnectorToolListResponse> localVarResponse = connectorsListToolsWithHttpInfo(tenantId, projectId, toolkit, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    return localVarResponse.getData();
  }
   ...
   * @param xPaletteProjectId Strict-auth project scope (optional)
   * @param xPaletteEnvironmentId Strict-auth environment scope (optional)
   * @return ApiResponse&lt;ConnectorToolListResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ConnectorToolListResponse> connectorsListToolsWithHttpInfo(String tenantId, String projectId, String toolkit, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = connectorsListToolsRequestBuilder(tenantId, projectId, toolkit, pageSize, pageToken, authorization, xPaletteApiKey, xPaletteProjectId, xPaletteEnvironmentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<ConnectorToolListResponse>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<ConnectorToolListResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ConnectorToolListResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder connectorsListToolsRequestBuilder(String tenantId, String projectId, String toolkit, Integer pageSize, String pageToken, String authorization, String xPaletteApiKey, String xPaletteProjectId, String xPaletteEnvironmentId) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
