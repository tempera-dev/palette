...
export class JudgeApi extends runtime.BaseAPI {
    ...
    /**
     */
    async judgeListLedgerRaw(requestParameters: JudgeListLedgerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JudgeLedgerListResponse>> {
        if (requestParameters['tenantId'] == null) {
            throw new runtime.RequiredError(
                'tenantId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => JudgeLedgerListResponseFromJSON(jsonValue));
    }

    /**
     */
    async judgeListLedger(requestParameters: JudgeListLedgerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JudgeLedgerListResponse> {
