...
export class SearchApi extends runtime.BaseAPI {
    ...
    /**
     */
    async searchSpansRaw(requestParameters: SearchSpansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SearchSpanListResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SearchSpanListResponseFromJSON(jsonValue));
    }

    /**
     */
    async searchSpans(requestParameters: SearchSpansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SearchSpanListResponse> {
