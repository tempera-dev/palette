...
import {
    ...
    ReviewTaskFromJSON,
    ReviewTaskToJSON,
    ReviewTaskListResponseFromJSON,
...
export class ReviewsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async reviewsListTasksRaw(requestParameters: ReviewsListTasksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReviewTaskListResponse>> {
        if (requestParameters['tenantId'] == null) {
            throw new runtime.RequiredError(
                'tenantId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReviewTaskListResponseFromJSON(jsonValue));
    }

    /**
     */
    async reviewsListTasks(requestParameters: ReviewsListTasksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReviewTaskListResponse> {
