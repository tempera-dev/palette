...
export class TracesApi extends runtime.BaseAPI {
    ...
    /**
     */
    async tracesListRaw(requestParameters: TracesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TraceListResponse>> {
        if (requestParameters['tenantId'] == null) {
            throw new runtime.RequiredError(
                'tenantId',
    ...
    /**
     */
    async tracesList(requestParameters: TracesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TraceListResponse> {
