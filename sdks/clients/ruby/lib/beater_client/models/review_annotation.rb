  ...
  class ReviewAnnotation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BeaterClient::ReviewAnnotation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BeaterClient::ReviewAnnotation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @annotation_id.nil?
        invalid_properties.push('invalid value for "annotation_id", annotation_id cannot be nil.')
      end
      ...
      if @reviewer_id.nil?
        invalid_properties.push('invalid value for "reviewer_id", reviewer_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reviewer_id.nil?
    ...
    def hash
      [annotation_id, created_at, payload, project_id, queue_id, reviewer_id, task_id, tenant_id, verdict].hash
    end
