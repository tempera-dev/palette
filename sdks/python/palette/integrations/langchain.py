...
>>> from palette.integrations.langchain import PaletteCallbackHandler
...
class PaletteCallbackHandler(BaseCallbackHandler):  # type: ignore[misc]
    """Maps LangChain runs (chains, LLMs, tools, retrievers) to Palette spans."""
