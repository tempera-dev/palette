"""LlamaIndex integration: a callback handler mapping events to Palette spans.

>>> from llama_index.core import Settings
>>> from llama_index.core.callbacks import CallbackManager
>>> from palette.integrations.llamaindex import PaletteLlamaIndexHandler
...
class PaletteLlamaIndexHandler(BaseCallbackHandler):  # type: ignore[misc]
    """Bridges LlamaIndex callback events into Palette spans."""
