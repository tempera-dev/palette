...
These are the ergonomic entry points for tracing arbitrary code as Palette spans.
"""
...
def span(
    ...
    *,
    ...
    """Open a Palette span as a context manager.

    >>> with palette.span("retrieve", kind=SpanKind.RETRIEVAL_QUERY) as s:
    ...     ...
    """
    tracer = get_tracer()
...
def observe(
    ...
    *,
    ...
    """Decorate a function so each call becomes a Palette span.
