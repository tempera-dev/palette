...
where
    F: Fn(String) -> std::result::Result<T, palette_core::IdError>,
{
...
mod tests {
    ...
    fn test_tenant_scope() -> TenantScope {
        TenantScope::new(
            ok(palette_core::TenantId::new("demo")),
            ok(palette_core::ProjectId::new("demo")),
            ok(palette_core::EnvironmentId::new("local")),
        )
    }
