...
use palette_ingest::{IngestOutcome, IngestPolicy, IngestService};
use palette_schema::{AgentSpanKind, SpanStatus, TraceView};
...
async fn import_source_mapping_projects_foreign_trace() {
    ...
    assert_eq!(span.normalizer_version, "palette-mapping-import-v1");
