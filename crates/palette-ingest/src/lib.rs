...
impl SourceImporter for NativeSpansImporter {
    ...
    fn normalize(
        ...
        Ok(RawTraceIngestRequest {
            ...
            source_schema_url: Some("palette://native/v1".to_string()),
            source_schema_version: Some("1".to_string()),
            normalizer_version: "palette-native-import-v1".to_string(),
...
fn mapping_normalizer_version() -> String {
    "palette-mapping-import-v1".to_string()
}
    ...
    fn normalize(
        ...
        Ok(RawTraceIngestRequest {
            ...
            source_schema_url: payload
                .config
                .source_schema_url
                .or_else(|| Some("palette://mapping/v1".to_string())),
...
impl IngestService {
    ...
    async fn prepare_native_batch(
        ...
        let span = CanonicalSpan {
            ...
            normalizer_version: "palette-native-v1".to_string(),
            tenant_id: request.scope.tenant_id.clone(),
            project_id: request.scope.project_id.clone(),
            environment_id: request.scope.environment_id.clone(),
...
pub struct NativeIngestRequest {
    ...
    pub cost: Option<palette_core::Money>,
...
/// `otel.`, `palette.`, `agent.`, `openinference.`, `w3c.`, `temporal.`,
...
mod tests {
    ...
    async fn native_ingest_preserves_raw_and_canonical_span() {
        ...
        assert_eq!(trace.spans[0].normalizer_version, "palette-native-v1");
    ...
    fn mapping_importer_projects_foreign_json_to_canonical_drafts() {
        ...
        assert_eq!(request.normalizer_version, "palette-mapping-import-v1");
