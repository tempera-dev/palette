//! `palette-prompts` - Mixdown prompt registry (ARCHITECTURE.md §20.6 #4.7).
//!
...
//! (the persistent store wired into the running paletted service). The `/v1`
//! prompt endpoints in `palette-api` are the live consumer of this crate.
