...
//! [`palette-eval`](../../palette_eval/index.html) attaches to an inconclusive
//! verdict:
//!
...
///
/// ```
/// use palette_stats::required_sample_size;
///
...
///
/// ```
/// use palette_stats::minimum_detectable_effect;
///
...
///
/// ```
/// use palette_stats::mcnemar_achieved_power;
///
