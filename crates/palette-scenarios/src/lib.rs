//! palette-scenarios — scenario mining & replay data engine.
//!
...
use palette_schema::{AgentSpanKind, CanonicalSpan, RedactionClass, SpanStatus};
use palette_store::{IntoStoreResult, StoreResult};
