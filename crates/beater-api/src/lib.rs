...
use beater_core::{
    ...
    PageRequest, ProjectId, PromptVersionId, ProviderSecretId, ReviewQueueId, ReviewTaskId,
    Sha256Hash, SpanId, TenantId, TenantScope, TraceId,
};
use beater_datasets::{
...
pub struct ApiState {
    ...
    /// endpoints broker managed-OAuth connections and tool execution; when
    /// `None` they report "not configured" (501).
...
pub const V1_ROUTE_COUNT: usize = 47;
