...
pub mod conventions {
    ...
    /// `PALETTE_*` environment variable names the SDKs read config from.
    pub mod env {
        pub const BASE_URL: &str = "PALETTE_BASE_URL";
        pub const TENANT_ID: &str = "PALETTE_TENANT_ID";
        pub const PROJECT_ID: &str = "PALETTE_PROJECT_ID";
        pub const ENVIRONMENT_ID: &str = "PALETTE_ENVIRONMENT_ID";
...
) -> Result<IdempotencyKey, palette_core::IdError> {
