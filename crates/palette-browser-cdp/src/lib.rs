//! CDP-backed [`palette_browser::BrowserDriver`] backend.
//!
...
//! ## Grounding contract
//!
//! Per [`palette_browser`], a failed-to-ground action is **not** a
...
mod tests {
    ...
    /// CI/sandbox. Run locally with `cargo test -p palette-browser-cdp -- --ignored`.
    #[tokio::test]
