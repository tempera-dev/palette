...
//! reconciles set ranges peer-to-peer. Palette has none of those consumers
...
const LEAF_DOMAIN: &[u8] = b"palette.merkle.leaf.v1";
/// Domain tag mixed into interior-node digests.
const NODE_DOMAIN: &[u8] = b"palette.merkle.node.v1";
/// Digest preimage for the empty corpus (a corpus with no leaves).
const EMPTY_DOMAIN: &[u8] = b"palette.merkle.empty.v1";
