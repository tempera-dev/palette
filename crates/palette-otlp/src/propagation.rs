//! W3C distributed-context propagation for Palette's async plumbing.
//!
//! Palette hands a trace across process boundaries it does not control with OTLP,
...
/// Keys whose baggage values Palette treats as sensitive and never propagates in
...
/// W3C baggage carrying Palette's tenant/project/release context.
///
...
/// fields Palette routes and bills on.
