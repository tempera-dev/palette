//! palette-identity — agent identity registry, capability leases, and emergency
...
use palette_core::{AgentId, EnvironmentId, Money, ProjectId, Timestamp, UserId};
use palette_schema::ModelRef;
