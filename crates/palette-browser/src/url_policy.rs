...
//! ## Wiring
//!
//! The policy type lives in the core `palette-browser` crate so every driver
//! backend (`palette-browser-cdp`, `palette-browser-playwright`,
//! `palette-browser-webdriver`) can import it without pulling in store or API
