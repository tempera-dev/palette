//! Temporal → Palette normalization.
//!
//! Converts a Temporal `GetWorkflowExecutionHistory` JSON document into Palette's
...
impl From<palette_core::IdError> for TemporalError {
    fn from(err: palette_core::IdError) -> Self {
...
/// `palette_otlp::export_to_raw_trace_ingest_request`.
